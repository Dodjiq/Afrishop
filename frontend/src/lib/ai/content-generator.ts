...
export interface ContentGenerationRequest {
  businessType: string          // 'fashion', 'electronics', 'food', etc.
  brandName: string
 ...
 */
export async function generateMultiSectionContent(
 ...
 */
function simulateAIGeneration(request: ContentGenerationRequest): GeneratedContent {
...
function generateHeroContent(businessType: string, brandName: string) {
...
function generateFeaturesContent(businessType: string) {
...
function generateTestimonialsContent(businessType: string) {
  return {
...
function generateFaqContent(businessType: string) {
  return {
...
function generateAboutContent(brandName: string, businessType: string) {
  return {
...
function generateCtaContent(brandName: string) {
  return {
 ...
 */
export async function callBackendAI(request: ContentGenerationRequest): Promise<GeneratedContent> {
